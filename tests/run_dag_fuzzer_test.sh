...
cc -fsanitize=fuzzer,address -O1 -g tests/fuzz/fuzz_dag_response.c dns_wire.o dns_utils.o dns_zone_parser.o -I. -o tests/fuzz/fuzz_dag_response -pthread -lcrypto -lm -lz
